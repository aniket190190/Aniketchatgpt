...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6902029981:AAEgPiT19AoC3fxEEpp14jI0N2G2CH6u8-8"
else:
    tgkey = tgenv
print(tgenv)
